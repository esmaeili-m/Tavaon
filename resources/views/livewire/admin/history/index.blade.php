            ...
            <div class="card">
                <div class="header">
                    ...
                    <a href="{{route('history.create')}}">
                        <button class="btn btn-info btn-border-radius waves-effect mx-2 me-0 mt-5">افزودن تاریخچه</button>
                    </a>
                    <div class="row">
                        <div class="col-sm-12 col-lg-3 mt-5">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <label class="form-label">تاریح خبر</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-lg-3 mt-5">
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($data ?? [] as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('staff.list',$item->id)}}"><button class="btn tblActnBtn">
                                            <i class=" material-icons">contacts</i>
                                        </button></a>
                                    <a href="{{route('history.update',$item->id)}}"><button class="btn tblActnBtn">

            ...
            <div class="card">
                <div class="header">
                    ...
                    <a href="{{route('event.trash')}}">
                        <button class="btn btn-info btn-border-radius waves-effect mx-0 me-0 mt-5">رویداد های حذف شده ( {{\App\Models\Events::onlyTrashed()->count()}} )</button>
                    </a>
                    <div class="row">
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($data ?? [] as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('event.update',$item->id)}}"><button class="btn tblActnBtn">

                    ...
                    <form class="form-horizontal" wire:submit.prevent="save">
                        <div class="row clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                <label for="email_address_2">عنوان رویداد</label>
                            </div>
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input wire:model.defer="title" type="text" class="form-control" placeholder="عنوان رویداد را وارد کنید">
                                        @error('title')
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                <label for="email_address_2">تاریخ رویداد</label>
                            </div>
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input wire:model.defer="time" type="text" class="form-control" placeholder="تاریخ رویداد را وارد کنید">
                                        @error('time')
                                        <div class="alert alert-danger mt-1">
                                            {{$message}}
                                        </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                <label for="email_address_2">لینک رویداد</label>
                            </div>
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    <div class="form-line">
                                        <input wire:model.lazy="slug" type="text" class="form-control" placeholder="لینک رویداد را وارد کنید">
                                        @error('slug')
                                        <div class="alert alert-danger mt-1">
                                            {{$message}}
                                        </div>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                <label for="email_address_2">توضیحات رویداد</label>
                            </div>
                            <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                <div class="form-group">
                                    ...
                                    <div class="form-line">
                                        <div class="file-field input-field">
                                            ...
                                            <div class="file-path-wrapper">
                                                <input wire:model.lazy="image" class="file-path validate" type="text">
                                            </div>
                                        </div>
                                        @if($image)
                                            <img style="border-radius: 5px" src="{{asset($image)}}" width="100px" height="100px">
                                        @endif
                                    </div>
                                </div>
                            </div>

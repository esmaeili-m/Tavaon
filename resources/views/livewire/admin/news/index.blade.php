            ...
            <div class="card">
                <div class="header">
                    ...
                    <a href="{{route('news.create')}}">
                        <button class="btn btn-info btn-border-radius waves-effect mx-2 me-0 mt-5">افزودن خبر</button>
                    </a>
                    <a href="{{route('news.trash')}}">
                        <button class="btn btn-info btn-border-radius waves-effect mx-0 me-0 mt-5">خبر های حذف شده ( {{\App\Models\News::onlyTrashed()->count()}} )</button>
                    </a>
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-3 mt-5">
                            <div class="form-group form-float">
                                <div class="form-line">
                                    ...
                                    <label class="form-label">توضیحات خبر</label>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-lg-3 mt-5">
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach($data ?? [] as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route('news.update',$item->id)}}"><button class="btn tblActnBtn">
